...
<aside>
    ...
    <main>
        <header>
            <h1>Empresas</h1>
            <menu>
                <form action="selectEmpresa" method="get" id="filtroRegiao" name="filtroRegiao">
                ...
                <form action="selectEmpresa" method="get" class="search" id="procuraEmpresaNome">
                    <input type="text" name="search" placeholder="Pesquisar por nome e email">
